...
100.times { |index| TodoList.create! id: index, list_name: "List #{index}", list_due_date: dates.sample }
...
users = User.create! [
  { id: 1, username: "jim", password: "abc123" },
  { id: 2, username: "rich", password: "123abc" }
]
